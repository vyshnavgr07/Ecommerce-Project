      ...
      <div className="container text-center text-md-left">
        <div className="row text-center text-md-left">
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
            Happy Feet, Inc. is a leading footwear and apparel retailer that unlocks the "inner sneakerhead" in all of us. With approximately 2,600 retail stores in 26 countries across North America, Europe, Asia, Australia, and New Zealand.
            </p>
          </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-12">
            <p className="text-center">
              Copyright &copy; 2023 All rights reserved by  Happy Feet 
            </p>
          </div>
        </div>
      </div>
