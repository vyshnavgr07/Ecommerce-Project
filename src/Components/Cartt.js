                ...
                <MDBCard key={item.id} className="rounded-3 mb-4">
                  <MDBCardBody className="p-4">
                    <MDBRow className="justify-content-between align-items-center">
                      ...
                      >
                     <button className='border border-secondary p-2 m-1' variant="danger"  onClick={()=>{handledec(item.id)}}  >-</button>
                        <span className='border border-secondary p-3 '>{item.quantity}</span>
                       
                        <button className='border border-secondary p-2 m-1' variant="danger"  onClick={()=>{handleinc(item.id)}} >+</button>
                      ...
                      <a href="#!" className="text-danger">
                               <MDBIcon
                                onClick={() => removeTask(cart.indexOf(item))}
...
<h1 > TOTAL {reducer}</h1>
<button   className='bg-warning m-2'  onClick={clearcart}  >ClearCart</button>
